...
print('#    Load sorted expression data:')
#  1. Load sorted expression data:
expr_data = pan.read_csv( out_path + "expression_reordered_01.csv",sep=',')
...
#     Load covariates:
covariates = pan.read_excel( in_path + "SI_Data_02_covariates.xlsx" )
...
dfres.to_csv(out_path+'expression_statsmodels_linreg_residuals_01.csv')
